...
test("resolve import", async () => {
  expect(
    await resolveImport("@/foo/bar", {
      absoluteBaseUrl: "/Users/bento-kit/Projects/foobar",
      paths: {
        "@/*": ["./src/*"],
  ...
  ).toEqual("/Users/bento-kit/Projects/foobar/src/foo/bar")
  ...
  ).toEqual("/Users/bento-kit/Projects/foobar/src/components/foo/bar/baz")
  ...
  ).toEqual("/Users/bento-kit/Projects/foobar/src/app/components/foo/bar")
  ...
  ).toEqual("/Users/bento-kit/Projects/foobar/lib/utils")
})
