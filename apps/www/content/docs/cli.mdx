...
```bash
npx bento-kit@latest add [component]
```
...
```txt
Usage: bento-kit add [options] [components...]
...
```txt
Usage: bento-kit diff [options] [component]
